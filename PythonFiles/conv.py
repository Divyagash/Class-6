...
# Code provided by the staff of 6.867 aditional comments added by me
...
class ArtistConvNet:
	def __init__(self, invariance=False):
        ...
        # If invariance was set to True invariance data will be used
	...
	def define_tensorflow_graph(self):
		...
		# Hyperparameters
        # Convolutional Neural Network(CNN) built with 4 layers,
